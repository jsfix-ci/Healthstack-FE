    ...
    <>
      <Routes>
        ...
        <Route path='/app' element={<PrivateOutlet />}>
          ...
          <Route path='/app/inventory/inv-dispense' element={<Dispense />} />
          <Route
            path='/app/inventory/inv-bill'
            element={<BillPrescription />}
          />
          ...
          <Route path='/app/labs/billservice' element={<BillService />} />
          <Route path='/app/labs/lab-result' element={<LabReport />} />
          <Route path='/app/labs/lab-bill' element={<BillLab />} />
          <Route path='/app/labs/labs' element={<Labs />} />
          <Route path='/app/labs/lab-payment' element={<LabPayment />} />

          <Route path='/app/pharmacy' element={<PharmacyHome />} />
          <Route path='/app/pharmacy/inv-dispense' element={<Dispense />} />
          <Route path='/app/pharmacy/inv-bill' element={<BillPrescription />} />
          <Route path='/app/pharmacy/inv-admin' element={<InventorySetup />} />
          <Route
            path='/app/pharmacy/inv-inventory'
            element={<InventoryStore />}
          />
          <Route path='/app/pharmacy/inv-entry' element={<ProductEntry />} />
          <Route path='/app/pharmacy/inv-exit' element={<ProductExit />} />
          <Route path='/app/pharmacy/inv-products' element={<Products />} />
          <Route path='/app/pharmacy/billservice' element={<BillService />} />
          <Route
            path='/app/pharmacy/inv-reports'
            element={<InventoryReport />}
          />
          <Route path='/app/pharmacy/inv-stores' element={<Pharmacy />} />
          <Route
